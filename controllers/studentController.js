...
module.exports.enrollStudent = async function (req, res) {
    ...
    const profileBelongsToUser = req.user.can('enroll self') && req.user.matchesStudentId(req.studentId);
...
module.exports.removeCourse = async function(req, res){
    ...
    const profileBelongsToUser = req.user.can('drop self') && req.user.matchesStudentId(req.studentId);
